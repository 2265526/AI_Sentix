# -*- coding: utf-8 -*-
"""
src/common/constants.py —— 业务常量
=====================================
对应《目录结构》中 src/common/constants.py 的职责："业务常量（如 doc_type）"。

集中放置与业务语义强相关、不随环境变化的常量；
环境变量可配置项一律放在 config/settings.py（见 Settings），此处不再重复。
"""
from typing import Tuple

# ------------------------------------------------------------
# 文档类型（与 kb_documents.doc_type 数据一致，None 表示不过滤）
# ------------------------------------------------------------
